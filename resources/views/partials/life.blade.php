<section class="pt-8 bg-blue-100">
    <div class="container max-w-3xl mx-auto px-2 sm:px-6 lg:px-8 py-6">
        <h2 class="text-xl sm:text-2xl font-borel text-center mb-8 sm:mb-12 text-gray-800">pengalaman organisasi</h2>
            ...
            <div class="grid grid-cols-2 sm:grid-cols-1 gap-2 sm:gap-6">
                <div class="bg-white p-3 sm:p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-start">
                        <div>
                            ...
                            <p class="text-xs sm:text-base text-gray-500 mt-1 sm:mt-2 line-clamp-2">Mengelola pengembangan sumber daya mahasiswa dan program pelatihan.</p>
                        </div>
                        <div class="text-left sm:text-right mt-1 sm:mt-0">
                            <span class="text-[10px] sm:text-sm text-gray-500">2024/2025</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white p-3 sm:p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-start">
                        ...
                        <div class="text-left sm:text-right mt-1 sm:mt-0">
                            <span class="text-[10px] sm:text-sm text-gray-500">Sekarang</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white p-3 sm:p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-start">
                        ...
                        <div class="text-left sm:text-right mt-1 sm:mt-0">
                            <span class="text-[10px] sm:text-sm text-gray-500">2021/2022</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white p-3 sm:p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-start">
                        ...
                        <div class="text-left sm:text-right mt-1 sm:mt-0">
                            <span class="text-[10px] sm:text-sm text-gray-500">2017-2019</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 sm:grid-cols-1 gap-2 sm:gap-6">
                <div class="bg-white p-3 sm:p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-start">
                        ...
                        <div class="text-left sm:text-right mt-1 sm:mt-0">
                            <span class="text-[10px] sm:text-sm text-gray-500">Agt 2024</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white p-3 sm:p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-start">
                        ...
                        <div class="text-left sm:text-right mt-1 sm:mt-0">
                            <span class="text-[10px] sm:text-sm text-gray-500">2022/2023</span>
                        </div>
                    </div>
                </div>
            </div>
